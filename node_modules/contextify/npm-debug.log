...
1 verbose cli [ '/usr/local/bin/node', '/usr/local/bin/npm', 'install', 'fs' ]
...
9 verbose lock fs /Users/mani/.npm/3f4bb586-fs.lock
...
15 verbose lock fs@ /Users/mani/.npm/a107b96b-fs.lock
16 silly addNameRange { name: 'fs', range: '*', hasData: false }
17 verbose url raw fs
18 verbose url resolving [ 'https://registry.npmjs.org/', './fs' ]
19 verbose url resolved https://registry.npmjs.org/fs
20 info trying registry request attempt 1 at 00:20:07
21 http GET https://registry.npmjs.org/fs
22 http 404 https://registry.npmjs.org/fs
23 silly registry.get cb [ 404,
23 silly registry.get   { date: 'Fri, 25 Apr 2014 04:20:08 GMT',
...
23 silly registry.get     'x-served-by': 'cache-v41-ASH, cache-at51-ATL',
23 silly registry.get     'x-cache': 'MISS, MISS',
23 silly registry.get     'x-cache-hits': '0, 0',
23 silly registry.get     'x-timer': 'S1398399608.127853632,VS0,VS8,VE92,VE97',
23 silly registry.get     'keep-alive': 'timeout=10, max=50',
23 silly registry.get     connection: 'Keep-Alive' } ]
24 silly lockFile a107b96b-fs fs@
25 silly lockFile a107b96b-fs fs@
26 error 404 'fs' is not in the npm registry.
26 error 404 You should bug the author to publish it
26 error 404 It was specified as a dependency of 'contextify'
26 error 404
26 error 404 Note that you can also install from a
26 error 404 tarball, folder, or http url, or git url.
27 error System Darwin 13.1.0
28 error command "/usr/local/bin/node" "/usr/local/bin/npm" "install" "fs"
29 error cwd /Users/mani/Courses/CS 6204 Cloud Environments/Project/code/snapshotContextLoader/node_modules/contextify
