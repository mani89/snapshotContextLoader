...
Handle<v8::Value> takeCustomSnap(const Arguments& args) {
...
//#endif
  ...
  /*
    const char* name = "simpleExample.js";

  //FILE* file = i::OS::FOpen("drbackExample.js", "rb");
    FILE* file = i::OS::FOpen("/Users/mani/Courses/CS 6204 Cloud Environments/Project/code/snapshotContextLoader/test/simpleExample.js", "rb");
...
*/
  ...
  HEAP->CollectAllGarbage(i::Heap::kNoGCFlags, "takeCustomSnap");
...
void init(Handle<Object> target){
  	//v8::Isolate* isolate = v8::Isolate::GetCurrent();
        target-> Set(String::NewSymbol("takeCustomSnap"),
                FunctionTemplate::New(takeCustomSnap)->GetFunction());
}


NODE_MODULE(takeCustomSnap, init);
